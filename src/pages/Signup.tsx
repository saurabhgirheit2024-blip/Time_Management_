...
import { Mail, Lock, User, UserPlus, Github, Chrome } from 'lucide-react';
    ...
    <div className="relative flex min-h-[85vh] items-center justify-center overflow-hidden py-12">
      ...
      >
        <Card 
          ...
          className="relative flex flex-col gap-6 p-8 border border-zinc-200/50 dark:border-zinc-800/50 backdrop-blur-xl bg-white/70 dark:bg-zinc-900/70 shadow-2xl rounded-2xl overflow-hidden"
        >
          ...
          <div style={{ transform: 'translateZ(30px)' }} className="text-center transition-all duration-300">
            ...
            <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400 font-medium">Start your productivity journey today</p>
          </div>
          ...
          <form onSubmit={handleSignup} style={{ transform: 'translateZ(40px)', transformStyle: 'preserve-3d' }} className="flex flex-col gap-4">
          ...
          <div style={{ transform: 'translateZ(30px)' }} className="grid grid-cols-2 gap-4">
            <Button variant="outline" className="h-11 gap-2 border-zinc-200/80 dark:border-zinc-800/80 hover:bg-zinc-50 dark:hover:bg-zinc-800/50 rounded-xl" onClick={handleGoogleSignup} isLoading={isLoading}>
          ...
          <p style={{ transform: 'translateZ(20px)' }} className="text-center text-sm text-zinc-500 dark:text-zinc-400 font-medium">
            ...
            <Link to="/login" className="font-bold text-emerald-600 dark:text-emerald-400 hover:underline">Log In</Link>
          </p>
        </Card>
      </motion.div>
    </div>
